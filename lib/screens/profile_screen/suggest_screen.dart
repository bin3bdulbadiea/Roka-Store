          ...
          child: Obx(
            () => Form(
              ...
              child: Column(
                ...
                children: [
                  'تقديم اقتراح'.text.size(25).semiBold.make(),
                  (context.screenHeight / 20).heightBox,
                  addPhotoTitle.text.size(18).semiBold.make(),
                  'يرجى إضافة صورة تقريبية للاقتراح الذي لديك'.text.make(),
                          ...
                          onPressed: () async {
                            if (formKey.currentState!.validate()) {
                              try {
                                ...
                                VxToast.show(context, msg: 'تم إرسال الاقتراح');

                                await controller.uploadImageInSuggest();

                                await controller.storeImageInSuggest(
