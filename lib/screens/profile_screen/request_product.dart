          ...
          child: Obx(
            () => Form(
              ...
              child: Column(
                ...
                children: [
                  requestProduct.text.size(25).semiBold.make(),
                  (context.screenHeight / 20).heightBox,
                  addPhotoTitle.text.size(18).semiBold.make(),
                  addPhotoSubtitleToRequestProduct.text.make(),
                  ...
                  TextFormField(
                    ...
                    decoration: const InputDecoration(
                      ...
                      hintText: addDescriptionToRequestProduct,
                    ),
                  ),
                          ...
                          onPressed: () async {
                            if (formKey.currentState!.validate()) {
                              try {
                                ...
                                VxToast.show(context, msg: sendRequest);

                                await controller.uploadImageInRequestProduct();

                                await controller.storeImageInRequestProduct(
